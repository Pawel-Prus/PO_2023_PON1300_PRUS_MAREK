...
public class SimulationTest {
    ...
    public void animalCollisionTest() {
        ...
        simulation.run();
        List<String> result = observator.getAllMessages();
        List<String> expectedResult = List.of("Animal > moved from (0,0) to (0,0)","Animal < moved from (1,0) to (1,0)","Animal > moved from (0,0) to (0,0)","Animal < moved from (1,0) to (1,0)");
        System.out.println(result);
    ...
    public void animalPlacingTest() {
        ...
        simulation.run();
        List<String> result = observator.getAllMessages();
        List<String> expectedResult = List.of("Animal > moved from (0,0) to (0,0)","Animal > moved from (0,0) to (1,0)");
        System.out.println(result);
